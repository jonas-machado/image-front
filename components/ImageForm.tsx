...
export default function ImageForm() {
  ...
  return (
    <div className="absolute top-1/2 -translate-y-1/2 w-full items-center">
      <div className="grid grid-cols-2 items-center gap-2 mx-2 h-auto w-full">
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          {!image2 ? (
            ...
            <div className="flex justify-center">
              <img src={image2} alt="" className="rounded-xl h-64" />
            </div>
          )}
      ...
      <div className="grid grid-cols-2 w-full text-center my-6">
